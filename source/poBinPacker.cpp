...
namespace po {
    ...
    //------------------------------------------------------------------------
    Rect BinPacker::packPosition(uint handle, uint *page) {
