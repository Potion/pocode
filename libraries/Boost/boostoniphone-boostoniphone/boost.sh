...
#: ${BOOST_LIBS:=" date_time filesystem prg_exec_monitor regex system test_exec_monitor thread unit_test_framework"}
: ${BOOST_LIBS:=" date_time filesystem system thread"}
