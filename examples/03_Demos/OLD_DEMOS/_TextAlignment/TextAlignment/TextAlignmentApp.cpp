...
poObject *createObjectForID(uint uid) {
	return new TextAlignmentApp();
}

void setupApplication() {
	applicationCreateWindow(0, WINDOW_TYPE_NORMAL, "TextAlignment", 100, 100, 700, 700);
}

void cleanupApplication() {
}

TextAlignmentApp::TextAlignmentApp() {
...
void TextAlignmentApp::eventHandler(poEvent *event) {
