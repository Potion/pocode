...
#pragma comment(lib, "pocode.lib")
#pragma comment(lib, "freeimage.lib")
#pragma comment(lib, "freetype248_D.lib")
#pragma comment(lib, "libboost_thread-vc100-mt-gd-1_45.lib")
#pragma comment(lib, "libboost_regex-vc100-mt-gd-1_45")
#pragma comment(lib, "libMikko.lib")
...
int APIENTRY WinMain(HINSTANCE hCurrentInst, HINSTANCE hPreviousInst, LPSTR lpszCmdLine, int nCmdShow) {
	...
	openConsoleWindow();
#endif
	// set the current path to the folder where the exe is
	char exe_path[255];
	GetModuleFileName(GetModuleHandle(NULL), exe_path, 255);
